...
# Includes minimal (N = 20) number of covariates plus the data PCs.
...
# OUTPUT ------------------------------------------------------------------
readr::write_rds(Gout.dmp, file= "/lustre/home/tpyork/projects/preg-maternal/data_objects/dmp-timepoint_day-20cov.rds")
