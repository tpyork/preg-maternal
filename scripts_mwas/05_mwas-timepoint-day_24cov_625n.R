...
pdata <- as_tibble(pData(gset.quant)) %>%
  select(study_id, ga_ad, timepoint_day,
         ...
         PCdata11, PCdata12, PCdata13, PCdata14, PCdata15, PCdata16, PCdata17, PCdata18, PCdata19, PCdata20,
         PCanc3,
...
# OUTPUT ------------------------------------------------------------------
readr::write_rds(Gout.dmp, file= "/lustre/home/tpyork/projects/preg-maternal/data_objects/dmp-timepoint_day-24cov.rds")
