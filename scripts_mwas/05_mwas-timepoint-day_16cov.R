...
# Includes minimal (N = 16) number of covariates.
...
# 1. MODEL DNAm CHANGE - 16 COVARIATES ----
...
# OUTPUT ------------------------------------------------------------------
readr::write_rds(Gout.dmp, file= "/lustre/home/tpyork/projects/preg-maternal/data_objects/dmp-timepoint_day-16cov.rds")
