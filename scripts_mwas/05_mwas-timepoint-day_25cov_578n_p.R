...
# out.x <- xpectr::suppress_mw(model_nocov(Mval[1267,], pdata))
out <- rbind(out.1, out.2, out.3, out.4)
# p_values <- as.numeric(out.x[4])
# qnorm(p_values / 2, lower.tail = FALSE)
...
# OUTPUT ------------------------------------------------------------------
readr::write_rds(Gout.dmp, file= "/lustre/home/tpyork/projects/preg-maternal/data_objects/dmp-timepoint_day-25cov.rds")
