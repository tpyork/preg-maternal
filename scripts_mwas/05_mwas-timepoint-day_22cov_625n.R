...
# Includes minimal (N = 22) number of covariates plus the data PCs.
...
# LOAD DATA ----
gset.quant <- readr::read_rds("/lustre/home/tpyork/projects/preg-maternal/data_objects/gset.quant.5.rds")
...
pdata <- as_tibble(pData(gset.quant)) %>%
  select(study_id, ga_ad, timepoint_day,
         ...
         PCdata1, PCdata2, PCdata3, PCdata4, PCdata5,
         PCanc3,
...
# OUTPUT ------------------------------------------------------------------
readr::write_rds(Gout.dmp, file= "/lustre/home/tpyork/projects/preg-maternal/data_objects/dmp-timepoint_day-22cov.rds")
