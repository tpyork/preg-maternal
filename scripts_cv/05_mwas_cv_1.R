...
# LOAD DATA ----
gset.quant <- readr::read_rds(paste0("/lustre/home/tpyork/projects/preg-maternal/data_objects_cv/cv_train_", fold, ".rds"))
...
# OUTPUT ------------------------------------------------------------------
readr::write_rds(Gout.dmp, file= paste0("/lustre/home/tpyork/projects/preg-maternal/data_objects_cv/mwas_cv_train_", fold, ".rds"))
